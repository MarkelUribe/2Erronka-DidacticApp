...
(function (document, $, wordfind) {
    ...
    // el: The jQuery element to write the puzzle to
    // puzzle: The puzzle to draw
    ...
    // puzzleEl: Selector to use when inserting the puzzle
    // options: WordFind options to use when creating the puzzle
  
    var WordFindGame = function (puzzleEl) {
      // Class properties, game initial config:
      var wordList, puzzle;
  
      // Game play events.
  
      // The following events handle the turns, word selection, word finding, and game end.
      ...
      //  Event that handles mouse down on a new square. Initializes the game state to the letter that was selected.
      ...
      /* Updates the game state when the previous selection was valid.
        {el} square: The jQuery element that was played
       */
      ...
      puzzle = wordfind.newPuzzleLax(wordList, { size: 7 });
      ...
      // When you press the 'Solve Puzzle' button, you call this function to show the missing words in different colors.
      this.solve = function () {
    ...
    function klaseaErabaki(w) {
      var klase = "";
      if (w == "izotza") {
        klase = "more_iluna";
        return klase;
      } else if (w == "koltxonetak") {
        klase = "more_argia";
        return klase;
      } else if (w == "aukera") {
        klase = "urdin_argia";
        ...
        klase = "urdin_iluna";
        return klase;
      } else if (w == "kontzertuak") {
        klase = "gorria";
        return klase;
      } else if (w == "herribazkaria") {
        klase = "berdea";
        return klase;
      } else if (w == "liburua") {
        klase = "laranja";
    ...
    WordFindGame.insertWordBefore = function (el, word) {
      ...
      $(".input-wrapper").addClass("columns-2");
    };
  
    // Allow game to be used wihint the browser
