...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-02-2023 a las 12:33:25
...
--
-- Estructura de tabla para la tabla `koordenadas`
--

CREATE TABLE `koordenadas` (
  `id` bigint(20) UNSIGNED NOT NULL,
  ...
  `lat` double NOT NULL,
  `lon` double NOT NULL,
  `kalea` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `img` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `koordenadas`
--

INSERT INTO `koordenadas` (`id`, `created_at`, `updated_at`, `izena`, `lat`, `lon`, `kalea`, `img`) VALUES
(1, NULL, NULL, 'Durango', 43.17164, -2.634701, '', ''),
(2, NULL, NULL, 'Landako Gunea', 43.1716, -2.6305, 'Landako Etorbidea, 6', '3. IRUDIA.png'),
...
(6, '2023_02_13_091256_create_koordenadas_table', 2);
...
--
-- Indices de la tabla `koordenadas`
--
ALTER TABLE `koordenadas`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `koordenadas`
--
ALTER TABLE `koordenadas`
